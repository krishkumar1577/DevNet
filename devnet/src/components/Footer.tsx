        ...
        <div className="py-16">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="mb-8 md:mb-0">
              <h2 className="font-quetine text-6xl md:text-8xl font-bold text-white">
                Krish
              </h2>
              <p className="text-neutral-400 text-lg mt-2 max-w-sm">
                Developer, designer, and storyteller sharing insights from the digital world.
              </p>
            </div>
          ...
          <div className="border-t border-neutral-800 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center text-sm text-neutral-400">
              <p>© 2025 Krish. All rights reserved.</p>
              <p className="mt-2 md:mt-0">Made with ❤️ and lots of coffee</p>
            </div>
          </div>
        </div>
      </div>
